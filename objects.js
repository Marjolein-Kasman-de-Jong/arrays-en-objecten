...
const myInfo = {
  firstName: "Marjolein",
  lastName: "Kasman-de Jong",
  age: 44,
  dateOfBirth: new Date(1979, 0, 16),
}
...
console.log("Hoi! Ik ben " + myInfo.firstName + ", ik ben " + myInfo.age + " jaar oud.");
...
const sentence = "De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1] + ".";
